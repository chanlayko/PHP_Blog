               ...
               if(isset($_POST['submit'])){
                   if(empty($_POST['name']) || empty($_POST['email'])){
                            ...
                            if($emResult){
                                ...
                                if($password != null){
                                    $adpdostat = $pdo -> prepare("UPDATE users SET user='$name',email='$email',password='$password',role='$role' WHERE id='$id'");
                                }else{
                                    $adpdostat = $pdo -> prepare("UPDATE users SET user='$name',email='$email',role='$role' WHERE id='$id'");
                ...
                <div class="card-body">
                 ...
                 <input type="hidden" name="id" value="<?php echo $result[0]['id']; ?>" >
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value="<?php echo escape($result[0]['user']) ?>" id="exampleInputEmail1" placeholder="Enter Name">
